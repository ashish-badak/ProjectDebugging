...
class MasterViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        switch SegueIdentifier(rawValue: segue.identifier!)! {
            case .showAllPhotos:
                destination.dataSource.fetchResult = allPhotos
            case .showCollection:
                ...
                destination.dataSource.fetchResult = PHAsset.fetchAssets(in: assetCollection, options: nil)
                destination.dataSource.assetCollection = assetCollection
        }
    }
